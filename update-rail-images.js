...
/**
 * Update Rail website HTML files to use AVIF → WebP → JPEG fallback strategy
 * 
 * This script processes all HTML files in the Rail website and converts
 ...
 */
function main() {
    console.log('🚀 Rail Website Image Optimization');
    console.log('==================================');
