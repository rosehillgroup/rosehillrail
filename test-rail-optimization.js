...
/**
 * Test script to verify Rail website image optimization is working correctly
 */

function testImageOptimization() {
    console.log('🧪 Testing Rail Website Image Optimization');
    console.log('=========================================');
    ...
    const testFiles = [
        ...
        'rrap.avif',
        'rrap.webp',
        'userworked_crossing.avif',
        'userworked_crossing.webp',
        'pedestrian_crossing.avif',
        'pedestrian_crossing.webp',
        'connect_home.avif',
        'connect_home.webp',
        'link_home.avif',
        'link_home.webp',
        'titan_home.avif',
        'titan_home.webp',
        'interlocking_home.avif',
        'interlocking_home.webp'
    ];
